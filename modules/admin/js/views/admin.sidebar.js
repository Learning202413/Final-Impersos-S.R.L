...
const NAV_LINKS = [
    { id: 'dashboard', name: 'Dashboard', icon: 'layout-dashboard', href: 'dashboard' },
    { id: 'produccion', name: 'Trabajos en curso', icon: 'kanban', href: 'produccion' },
    { id: 'historial-global', name: 'Historial de cambios', icon: 'history', href: 'historial-global' },
    { id: 'historial-orden', name: 'Rastreo de pedidos', icon: 'file-search', href: 'historial-orden' },
