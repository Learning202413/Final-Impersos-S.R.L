...
export const CalidadController = {
    ...
    setupEvents() {
        ...
        // Aprobación de QC (ACTUALIZADO con llamada al servicio)
        document.getElementById('btn-approve-qc')?.addEventListener('click', async () => {
            ...
            // Llamada al servicio para loguear
            await CalidadService.approveQualityCheck(this.currentTaskId);
        ...
        // Rechazo de QC (ACTUALIZADO con llamada al servicio)
        document.getElementById('btn-reject-qc')?.addEventListener('click', async () => {
            ...
            // Llamada al servicio para loguear
            await CalidadService.rejectQualityCheck(this.currentTaskId, comments);
